    ...
    return (
        <div className="column column--lg_3">
          <h3>Info Facture</h3>
            ...
            <p className="column__description"><span className={badgeStyle}>{badgeText}</span></p>


            <p className="column__title">Montant total:</p>
              <p className="column__description">{user.association.bankInformation.currency} { bill.amount }</p>
