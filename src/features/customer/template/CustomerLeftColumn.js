    ...
    return(
            <div className="column column--lg_3">              
                <h3>Nom du client</h3>
                  ...
                  <p className="column__description mb-0">{customer.street+" "+customer.street_number}</p>
                  <p className="column__description">{customer.zip_code+" "+customer.city}</p>
    

                  <p className="column__title">Telephone :</p>
                  <p className="column__description">{customer.phone}</p>
